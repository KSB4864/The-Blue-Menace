...
def create_level1(block_list,all_sprites_list,player):
    ...
    walls = [[710,80,600,20,WHITE],
        [690,80,40,20,GREEN],
        [580,410,170,140,WHITE],
        [700,200,600,20,WHITE],
        [690,100,650,350,WHITE],
        [870,0,80,290,WHITE],
...
background_image = pygame.image.load("l1bg.png").convert()
